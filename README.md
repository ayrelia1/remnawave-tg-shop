...
-   **Бонус за имя в Telegram:** При `NAME_BONUS_ENABLED=True` после любой успешной покупки можно получать 5 дней доступа раз в 30 дней через кнопку «Получить 5 дней». Для выдачи нужен префикс `@mansurvpn_bot` в начале поля «Имя». Бот проверяет имя каждые 30 минут в течение 5 дней; при удалении префикса списывает оставшуюся часть бонуса. Если подписка истекла, бонус создаёт новый доступ на 5 дней.
